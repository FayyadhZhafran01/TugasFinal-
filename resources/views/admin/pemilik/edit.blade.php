@extends('layouts.app', ['title' => 'EDIT PEMILIK - Admin'])
@section('content')
<main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-300">
    <div class="container mx-auto px-6 py-8"> <div class="p-6 bg-white rounded-md shadow-md"> <h2 class="text-lg
        text-gray-700 font-semibold capitalize">EDIT PEMILIK</h2> <hr class="mt-4"> <form
        action="{{ route('admin.pemilik.update', $pemilik->id) }}" method="POST">
        @csrf @method('PUT') 
    <div> <label class="text-gray-700" for="nama">NAMA</label>
            ...
            $pemilik->nama) }}" placeholder="masukkan nama">
            @error('nama')
...
rounded-md overflow-hidden mt-2">
    ...
    <div> <label class="text-gray-700" for="alamat">ALAMAT</label>
            ...
            $pemilik->alamat) }}" placeholder="Masukkan alamat pemilik">
            @error('alamat')
            <div class="w-full bg-red-200 shadow-sm
rounded-md overflow-hidden mt-2">
                <div class="px-4 py-2">
    ...
    <div> <label class="text-gray-700" for="nomor_hp">NOMOR HP</label>
            ...
            $pemilik->nomor_hp) }}" placeholder="harga jual">
            @error('nomor_hp')
            <div class="w-full bg-red-200 shadow-sm
rounded-md overflow-hidden mt-2">
                <div class="px-4 py-2">
